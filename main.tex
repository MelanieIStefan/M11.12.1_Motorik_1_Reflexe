...
\begin{frame}{Das Kleinhirn dient der Feinabstummung der Motorik}
...
\begin{itemize}
    \item Nystagmus: Unwillürliche und unkontrollierte Augenbewegungen
...
\begin{center}
    \includegraphics[width= 0.8\textwidth]{sistine_chapel.jpg}
\end{center}
...
\begin{column}{5cm}
Bewegungsanleitungen werden durch deszendierende Bahnen an spinale Neuronen weiter gegeben
         \item Afferente Bahnen und deszendierende Motorefferenzen konvergieren i.d.R. auf spinalen Interneuronen. Dies erlaubt eine Modifikation des Bewegunsprogramms und Anpassung an tatsächliche Gegebenheiten. Aktualisierte Motorinstruktoin wird an \(\alpha\)-Motoneurone weitergeleitet, und es kommt schließlich zur Muskelkontraktion
\end{column}
...
\begin{itemize}
    ...
    \item
    Diese Rückwärtshemmung verhindert die Überstimulierung von \(\alpha\)-Motoneuronen des kontrahierenden Muskels und verhindert so zu hohe/zu lange Kontraktion des Muskels
    \item
    Supraspinale Zentren können Renshaw-Zellen inhibieren (und dadurch \(\alpha\)-Motoneuronen disinhibieren)
\end{itemize}   

\begin{center}
    \includegraphics[width=\textwidth]{renshaw.png}
\end{center}
...
\begin{itemize}
\item
Verhindert das Afubauen von zu starker Spanning um Muskel
    \item 
    Muskelspannung stimuliert 1b-Afferenz über Golgisehnenorgan
    \item
    1b Afferenz stimuliert hemmende (-) und erregende (+) Interneurone im Rückenmark
    \item
    Hemmende Interneurone hemmen \(\alpha\)-Motoneurone des Agonisten (Agonist hemmt sich selbst)
    \item
    Aktivierende Interneurone erregen \(\alpha\)-Motoneurone des \textbf{Anta}gonisten, der Antagonist kontrahiert
\end{itemize}
