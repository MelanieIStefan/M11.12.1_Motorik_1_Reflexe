...
% \begin{center}
%     \includegraphics[width=0.6\textwitdh]{cerebellum_layers.png}
% \end{center}
...
%      \item Repertoire an Bewegungen (je nach Reizstärke können unterschiedliche Muskel miteinbezogen werden.)
%      \end{itemize}
