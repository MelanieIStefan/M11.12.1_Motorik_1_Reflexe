...
Calcium wird schließlich wieder entfernt durch Pumpen und Na\textsuperscript{2+}/Ca\textsuperscript{2+}-Austausch
...
\begin{frame}{Muskelspindeln messen den Kontraktionszustand des Muskels}
Je nach Anordnung der Zellkerne werden zwei Arten von Fasern unterschieden: 
...
Von Ia Afferenzen innerviert (messen Geschwindigkeit der Längenveränderung)
        ...
        Von Ia Afferenzen innerviert (messen Geschwindigkeit der Längenveränderung\\
        \textbf{und} von  II Afferenzen innerviert (Endbereiche der Kernkettenfaser, messen absolute Längenveränderung)
\end{itemize}
...
% 1a-Fasern feuern mit niedriger Frequenz im Ruhezustand, mit hoher Frequenz bei Dehnung.  Aber was ist bei Stauchung?
